...
Contributions to software can be made under different roles.
Depending on the type of the contribution, contributors can be eligible for authorship if the 
...
### How to become an author on this project? / How to stop being an author on this project? {#author}
