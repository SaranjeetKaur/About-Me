...
date: "2023-04-17"
categories: [RSE Asia, Community Building, Research Software Engineering, NRENs, Asia, Research Community Management, dRTP]
description: "Blog post about NRENs and the RSE community in Asia"
draft: false
---

*Originally posted on Research Software Alliance's [blog](https://www.researchsoft.org/blog/2023-04/)*.

![(From left to right and top to bottom) My presentation about the RSE Asia Association, RSE Asia Association goodies, Twitter thread about the activity. Image credit: Saranjeet Kaur Bhogal](preview.png){width="600"}
...
### National Research and Education Networks in Asia {#national-research-and-education-networks-in-asia}
...
**Acknowledgements:** *This blog post has benefitted from the suggestions and feedback by [Michelle Barker](https://www.linkedin.com/in/michelledbarker/) and [Paula Andrea Martinez](https://www.linkedin.com/in/pambio/).*
